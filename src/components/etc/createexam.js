...
function CreateExam(props) {
        ...
        fetch(api_url + '/user/finduserbyid/' + memberID, {
            ...
            try {
                ...
                var elmTmp = arrTmp.map((item, index) => {
                    return <button key={index} className="btn btn-sm mr-1">{item.fullName}</button>;
                });
    ...
    useEffect(() => {
        localStorage.setItem('listProblemIsCreated', JSON.stringify([]));
    }, []);
    useEffect(() => {
    ...
    return (
        <>
            <div className="create-exam">
                <h3 className="text-center" style={{ marginTop: "25px", marginBottom: "25px" }}>
                    Tạo kì thi
                </h3>
                <div className="row ml-4">
                    ...
                    <div className="col-25">
                        <input type="text" placeholder="Tên kì thi" onChange={(e) => handleChangeExamName(e)} />
                    </div>
                </div>
                <div className="row ml-4">
                    <div className="col-25">
                    ...
                    <div className="col-25">
                        <input type="text" placeholder="Mã code" onChange={(e) => handleChangeExamCode(e)} />
                    </div>
                </div>
                <div className="row ml-4">
                    <div className="col-25">
                ...
                <div className="row ml-4">
                    ...
                    <div className="col-25 mr-3">
                        <input className="mt-2" type="text" disabled={(selectRange ? true : false)} placeholder="Nhập ID thí sinh. . ." onChange={(e) => handleChangeMemberID(e)} />
                ...
                <div className="row ml-4">
                    ...
                    <div className="col-25">
                        <Calendar disableCalendar={true} callBackSaveTimeExam={callBackSaveTimeExam} />
                    </div>
                </div>
                <div className="row ml-4">
                    <div className="col-25">
