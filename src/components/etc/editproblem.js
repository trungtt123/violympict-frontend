...
function EditProblem(props) {
    ...
    var problemID =  window.location.pathname.split('/')[4];
    ...
    const handleEditTestCase = (test, index) => {
        var data = {
            ...
            score: localStorage.getItem('editscore') === null ? test.timeLimit : JSON.parse(localStorage.getItem('editscore'))
        }
    ...
    const handleAddTestCase = () => {
        var elmtmp = <>
            ...
            <div className="col-25 mt-4">Điểm</div>
            <div className="col-25 mt-3">
                <input type="text" placeholder="Nhập điểm của test" onChange={(e) => getScoreOfTest(e)} />
            </div>
            <div className="col-25 ml-3">
    ...
    if (curProblem !== undefined)
    return <>
        <NotificationContainer/>
        <div className="create-exam">
            <h4 className="text-info ml-4 mt-4">Chỉnh sửa bài tập</h4>
            <div className="problem">
                <div className="row ml-4">
                    ...
                    <div className="col-25">
                        <input type="text" defaultValue={curProblem.problemName} placeholder="Tên bài" onChange={(e) => handleChangeProblemName(e)} />
                    </div>
                </div>
                <div className="row ml-4">
                    <div className="col-25">
                    ...
                    <div className="col-25">
                        <input type="text" defaultValue={curProblem.problemTags} placeholder="Tags" onChange={(e) => handleChangeProblemTags(e)} />
                    </div>
                </div>
                <div className="row ml-4">
                    <div className="col-25">
                    ...
                    <div className="col-25">
                        <input type="text" defaultValue={curProblem.problemMemoryLimit} placeholder="Giới hạn bộ nhớ" onChange={(e) => handleChangeProblemMemoryLimit(e)} />
                    </div>
                </div>
                <div className="row ml-4">
                    <div className="col-25">
                ...
                <div className="row ml-4">
                    ...
                    <div className="col-75">
                        <CKEditor
                            ...
                            data={curProblem.problemContent}
