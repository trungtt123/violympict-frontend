    ...
    if (checked === true) {
        return (
            <>
                ...
                <div className="form-check-control ml-4 mt-2" style={{marginBottom: "20px"}}>
                    <input className="form-check-input" type="checkbox" checked={checked} onChange={() => handleChangeChecker()} />
