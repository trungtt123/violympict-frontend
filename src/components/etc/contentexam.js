    ...
    useEffect(() => {
        ...
        fetch(api_url + '/exam/getexamforexamier/' + examID, {
            ...
            if (data.success === true) {
                        ...
                        return <>
                            <div className="row ml-2" id={problemCSSID}>
                                ...
                                Giới hạn bộ nhớ: {problem.problemMemoryLimit} megabyte <br />
                                    ...
                                    <button class="btn btn-danger btn-sm ">Báo cáo</button>
                                </div>
                ...
                setElmSubmieExam(<button className="btn btn-info" onClick={() => handleEndPoint("Kết thúc bài thi", true)}>Kết thúc bài thi</button>)
